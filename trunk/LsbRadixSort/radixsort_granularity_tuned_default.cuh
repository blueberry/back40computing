...
template <
	...
	typename ValueType,
	typename IndexType>
struct DefaultGranularityConfig : 
	GranularityConfig<
		...
		(SM_ARCH >= 120) ? 					1 :		// vec-1 loads on GT200
		...
		(SM_ARCH >= 120) ? 					6 :		// 64 threads/CTA on GT200
											7,		// 128 threads/CTA on G80/90
		...
		(SM_ARCH >= 120) ? 					1 :		// 2 loads/cycle on GT200
