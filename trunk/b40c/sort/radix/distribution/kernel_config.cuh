...
/******************************************************************************
 * "Metatypes" for guiding distribution sorting granularity configuration
 ******************************************************************************/
...
/**
 * Type of distribution sorting problem
 */
template <
	typename _KeyType,
	typename _ValueType,
...
struct ProblemType 
{
	...
	// for radix sorting 
	typedef typename KeyTraits<_KeyType>::ConvertedKeyType ConvertedKeyType;

	// The type of values we are operating upon
	typedef __ValueType ValueType;

	// The integer type we should use to index into data arrays (e.g., size_t, uint32, uint64, etc)
	typedef _SizeT SizeT;
	
	// The number of bits per radix digit
