...
struct TunedConfig<ProblemType, SM20, LARGE, T, 1>
	: ProblemConfig<ProblemType, SM20, util::io::ld::NONE, util::io::st::NONE, false, true, false, 11,
	  8, 7, 2, 2,
	  5, 2, 0, 5,
	  8, 7, 2, 2, 5>
{
...
struct TunedConfig<ProblemType, SM20, LARGE, T, 2>
	: ProblemConfig<ProblemType, SM20, util::io::ld::NONE, util::io::st::NONE, false, true, false, 10,
	  8, 7, 1, 2,
	  5, 2, 0, 5,
	  8, 6, 2, 2, 5>
{
...
struct TunedConfig<ProblemType, SM20, LARGE, T, 4>
	: ProblemConfig<ProblemType, SM20, util::io::ld::NONE, util::io::st::NONE, false, false, false, 11,
	  8, 7, 2, 2,
	  5, 2, 0, 5,
	  8, 9, 1, 1, 5>
{
...
struct TunedConfig<ProblemType, SM20, LARGE, T, T_SIZE>
	: ProblemConfig<ProblemType, SM20, util::io::ld::NONE, util::io::st::NONE, false, false, false, 8,
	  8, 7, 0, 1,
	  5, 2, 0, 5,
	  8, 5, 1, 2, 5>
{
...
struct TunedConfig<ProblemType, SM20, SMALL, T, T_SIZE>
	: ProblemConfig<ProblemType, SM20, util::io::ld::NONE, util::io::st::NONE, false, false, false, 7,
	  8, 5, 1, 1,
	  5, 2, 0, 5,
	  8, 5, 0, 2, 5>
{
...
struct TunedConfig<ProblemType, SM13, LARGE, T, 1>
	: ProblemConfig<ProblemType, SM13, util::io::ld::NONE, util::io::st::NONE, false, false, false, 12,
	  8, 8, 2, 2,
	  6, 2, 0, 5,
	  8, 8, 2, 1, 5>
{
...
struct TunedConfig<ProblemType, SM13, LARGE, T, 2>
	: ProblemConfig<ProblemType, SM13, util::io::ld::NONE, util::io::st::NONE, false, false, false, 10,
	  8, 7, 1, 1,
	  6, 2, 0, 5,
	  8, 6, 2, 2, 5>
{
...
struct TunedConfig<ProblemType, SM13, SMALL, T, 2>
	: ProblemConfig<ProblemType, SM13, util::io::ld::NONE, util::io::st::NONE, false, true, false, 9,
	  8, 6, 1, 2,
	  6, 2, 0, 5,
	  8, 5, 2, 2, 5>
{
...
struct TunedConfig<ProblemType, SM13, SMALL, T, T_SIZE>
	: ProblemConfig<ProblemType, SM13, util::io::ld::NONE, util::io::st::NONE, false, false, false, 6,
	  8, 5, 0, 1,
	  6, 2, 0, 5,
	  8, 5, 1, 0, 5>
{
	...
	util::CtaWorkDistribution<typename ProblemType::SizeT> work_decomposition)
{
	...
	DownsweepPass<KernelConfig>(d_in, d_out, d_spine, work_decomposition, smem_storage);
}
