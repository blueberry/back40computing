...
// Target threadblock occupancy for small-problem uber sorting kernel
#define B40C_SM20_UBER_CTA_OCCUPANCY()						(7)			// 7 threadblocks on GF100
#define B40C_SM12_UBER_CTA_OCCUPANCY()						(5)			// 5 threadblocks on GT200
#define B40C_SM10_UBER_CTA_OCCUPANCY()						(2)			// 2 threadblocks on G80
#define B40C_RADIXSORT_UBER_CTA_OCCUPANCY(version)			((version >= 200) ? B40C_SM20_UBER_CTA_OCCUPANCY() : 	\
			    											 (version >= 120) ? B40C_SM12_UBER_CTA_OCCUPANCY() : 	\
				    															B40C_SM10_UBER_CTA_OCCUPANCY())		
