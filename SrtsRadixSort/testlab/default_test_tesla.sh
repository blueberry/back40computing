...
do
	...
	do
		...
		echo ../bin/test_radix_sort_advanced_3.0 --i=4 --n-input=input/problem_sizes_32_268M.dat --key-bytes=$KEYBYTES --value-bytes=$VALUEBYTES 
		../bin/test_radix_sort_advanced_3.0 --i=4 --n-input=input/problem_sizes_32_268M.dat --key-bytes=$KEYBYTES --value-bytes=$VALUEBYTES 
