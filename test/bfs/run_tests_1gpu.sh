...
do
	...
	./bin/test_bfs_4.0_i386 metis ../../../graphs/$i $OPTIONS --uneven --mark-parents > eval/$SUFFIX/$i.$SUFFIX.parent.txt 
	sleep 10 
done
...
do
	...
	sleep 10 
	echo ./bin/test_bfs_4.0_i386 metis ../../../graphs/$i $OPTIONS --uneven --mark-parents
	./bin/test_bfs_4.0_i386 metis ../../../graphs/$i $OPTIONS --uneven --mark-parents > eval/$SUFFIX/$i.$SUFFIX.parent.txt 
	sleep 10 
done
