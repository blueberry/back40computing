...
__launch_bounds__ (
	(AutotunedClassifier<ProblemType, __CUB_CUDA_ARCH__, (ProbSizeGenre) PROB_SIZE_GENRE>::Policy::Upsweep::THREADS),
	(AutotunedClassifier<ProblemType, __CUB_CUDA_ARCH__, (ProbSizeGenre) PROB_SIZE_GENRE>::Policy::Upsweep::MIN_CTA_OCCUPANCY))
...
template <typename ProblemType, int PROB_SIZE_GENRE>
__launch_bounds__ (
	(AutotunedClassifier<ProblemType, __CUB_CUDA_ARCH__, (ProbSizeGenre) PROB_SIZE_GENRE>::Policy::Spine::THREADS),
	(AutotunedClassifier<ProblemType, __CUB_CUDA_ARCH__, (ProbSizeGenre) PROB_SIZE_GENRE>::Policy::Spine::MIN_CTA_OCCUPANCY))
