...
public:
	 ...
	 * @param num_elements
	 * 		Number of elements to consecutive reduction
	 * @param max_grid_size
...
struct Detail
{
	typedef consecutive_reduction::ProblemType<T, Flag, SizeT, EXCLUSIVE, BinaryOp, Identity> ProblemType;
	...
	int max_grid_size)
{
	...
	do {
		...
		// Invoke consecutive reduction pass
