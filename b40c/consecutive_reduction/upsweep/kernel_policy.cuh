...
/******************************************************************************
 * Configuration policy for consecutive reduction upsweep reduction kernels
 ******************************************************************************/
...
/**
 * A detailed consecutive reduction kernel configuration policy type that specializes kernel
