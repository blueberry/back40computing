...
do
	...
	./bin/test_bfs_4.0_i386 metis ../../../../graphs/$i $OPTIONS --mark-parents > eval/$i.$SUFFIX.parent.txt 
	sleep 5 
done
...
do
	...
	sleep 5 
	echo ./bin/test_bfs_4.0_i386 metis ../../../../graphs/$i $OPTIONS --queue-sizing=0.5 --mark-parents
	./bin/test_bfs_4.0_i386 metis ../../../../graphs/$i $OPTIONS --queue-sizing=0.5 --mark-parents > eval/$i.$SUFFIX.parent.txt 
	sleep 5 
done
...
do
	...
	sleep 5 
	echo ./bin/test_bfs_4.0_i386 market ../../../../graphs/$i $OPTIONS --mark-parents
	./bin/test_bfs_4.0_i386 market ../../../../graphs/$i $OPTIONS --mark-parents > eval/$i.$SUFFIX.parent.txt 
	sleep 5 
done
...
./bin/test_bfs_4.0_i386 grid2d 5000 --queue-sizing=0.7 $OPTIONS > eval/grid2d.5000.$SUFFIX.txt	
	sleep 5 
echo /bin/test_bfs_4.0_i386 grid2d 5000 --queue-sizing=0.7 $OPTIONS --mark-parents 
./bin/test_bfs_4.0_i386 grid2d 5000 --queue-sizing=0.7 $OPTIONS --mark-parents > eval/grid2d.5000.$SUFFIX.parent.txt	
	sleep 5 
...
./bin/test_bfs_4.0_i386 grid3d 300 --queue-sizing=0.6 $OPTIONS > eval/grid3d.300.$SUFFIX.txt	
	sleep 5 
echo /bin/test_bfs_4.0_i386 grid3d 300 --queue-sizing=0.6 $OPTIONS --mark-parents 
./bin/test_bfs_4.0_i386 grid3d 300 --queue-sizing=0.6 $OPTIONS --mark-parents > eval/grid3d.300.$SUFFIX.parent.txt	
	sleep 5 
